...
%Header is formated as: NameOfDB/40bytes, SizeOfSizeOfDocs/8bytes,SyzeOfVersion/8bytes,PointerForRoot/8Bytes.
create_db(Name, SizeOfSizeOfDoc, SizeOfVersion) -> 
	...
	Header = <<NameBin/binary, SizeOfSizeOfDoc:8/unit:8, SizeOfVersion:8/unit:8, ?SizeOfHeader:?SizeOfPointer/unit:8>>,
